...
<input type="hidden" name="hosted_button_id" value="6DDMDBQ45SJAA">
</form>
              ...
              <li><a href="http://www.taffydb.com/beginner#" onclick="document.getElementById(&#39;paypal&#39;).submit()">Donate</a>
</li>
...
<script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0];if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src="//platform.twitter.com/widgets.js";fjs.parentNode.insertBefore(js,fjs);}}(document,"script","twitter-wjs");</script>
        ...
        <div class="span9">
          <div class="hero-unit">
            ...
            <p>TaffyDB is very easy to get started with. This brief turtoial will introduce you to a few of the core concepts and should be enough to get started even if you aren't already a web developer.</p>
			
			<h3>Step 1: Creating a quick sandbox</h3>
				<p>It is recmmended that you download and use your own copy of TaffyDB, but for the purposes of playing around you can use the latest version right off of GitHub. If you have never created a web page before you can simply create a text document, include the code below, and save it to your desktop as test.html.</p>
				<pre>&lt;html&gt;
	&lt;head&gt;
...
&lt;/html&gt;</pre>
				<p>The script tag imports TaffyDB right onto the page.</p>

			<h3>Step 2: Your First DB</h3>
				<p>Let's create a DB to store some city information. You'll need another script tag and you'll be writing JavaScript.</p>
				<pre>&lt;html&gt;
	&lt;head&gt;
		&lt;script src="https://github.com/typicaljoe/taffydb/raw/master/taffy.js"&gt;&lt;/script&gt;
		&lt;script&gt;
...
&lt;/html&gt;</pre>
			<h3>Step 3: Adding records</h3>
				<p>You can add records on creation and via the .insert() method. Below we are doing both.</p>
				<pre>&lt;html&gt;
	&lt;head&gt;
		&lt;script src="https://github.com/typicaljoe/taffydb/raw/master/taffy.js"&gt;&lt;/script&gt;
		&lt;script&gt;
...
&lt;/html&gt;</pre>
			<h3>Step 4: Your first query</h3>
				<p>Our city db is itself a function that accepts a filter object (an object that will be matched to records). Let's query for Boston. We will alert the .count() method to see our results.</p>
				<pre>&lt;html&gt;
	&lt;head&gt;
		&lt;script src="https://github.com/typicaljoe/taffydb/raw/master/taffy.js"&gt;&lt;/script&gt;
		&lt;script&gt;
...
&lt;/html&gt;</pre>
			...
			<h3>Step 5: Chaining methods</h3>
				<p>You can chain together. Below we will get the first two records from the DB and use the .each() method to alert their names.</p>
				<pre>&lt;html&gt;
	&lt;head&gt;
		&lt;script src="https://github.com/typicaljoe/taffydb/raw/master/taffy.js"&gt;&lt;/script&gt;
		&lt;script&gt;
...
&lt;/html&gt;</pre>
			...
			<h3>Step 6: Updating data</h3>
				<p>You may have noticed that New York is in the wrong state. Let's fix that and alert the new state. </p>
				<pre>&lt;html&gt;
	&lt;head&gt;
		&lt;script src="https://github.com/typicaljoe/taffydb/raw/master/taffy.js"&gt;&lt;/script&gt;
		&lt;script&gt;
...
&lt;/html&gt;</pre>
			...
			<h3>Step 7: Sorting</h3>
				<p>Sorting is a big part of TaffyDB using the .order() method.</p>
				<pre>&lt;html&gt;
	&lt;head&gt;
		&lt;script src="https://github.com/typicaljoe/taffydb/raw/master/taffy.js"&gt;&lt;/script&gt;
		&lt;script&gt;
...
&lt;/html&gt;</pre>
			<h3>What's next</h3>
				<p>There are a lot of other methods you can use against your data. Some highlights include .remove() to delete records, .get() to get an array of records, and .supplant to merge records with a string template. Continue to browse the docs for more ways to use TaffyDB.</p>
