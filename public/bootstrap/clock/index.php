...
<link rel='stylesheet' href='http://localhost:/prob/bd_diga/public/bootstrap/font-awesome/font-awesome.css' />
<!-- BOOT JQUERY 2.0.0 -->
<script src='http://localhost:/prob/bd_diga/public/bootstrap/assets/js/jquery2.0.0.js'></script>
<!-- BOOTSTRAP 2.3.2 JS -->
<script src='http://localhost:/prob/bd_diga/public/bootstrap/assets/js/bootstrap2.3.2.js'></script>


  <script type="text/javascript" src="jquery-clock-timepicker.js"></script>
 ...
 <body>
  <div class="main">
   <h1>jQuery Clock Time Picker v2.6.4</h1>
