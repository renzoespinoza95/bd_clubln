...
-- Volcando datos para la tabla bd_cristomo.fotoxusu: ~1 rows (aproximadamente)
...
-- Volcando datos para la tabla bd_cristomo.msg: ~1 rows (aproximadamente)
...
-- Volcando datos para la tabla bd_cristomo.pagweb: ~1 rows (aproximadamente)
...
-- Volcando datos para la tabla bd_cristomo.submenu: ~14 rows (aproximadamente)
