...
/*
public static function url_amigable($texto) {
    ...
    // Reemplazar caracteres con tilde y ñ por equivalentes ASCII
    $texto = iconv('UTF-8', 'ASCII//TRANSLIT//IGNORE', $texto);

    // Reemplazar espacios por guiones
    $texto = str_replace(' ', '-', $texto);

    // Eliminar cualquier carácter que no sea letra o número o guión
    $texto = preg_replace('/[^a-z0-9\-]/', '', $texto);

    // Opcional: eliminar guiones múltiples seguidos por uno solo
